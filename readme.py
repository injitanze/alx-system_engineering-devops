...
git clone https://github.com/injitanze/AirBnB_clone After cloning the repository you will have a folder called AirBnB_clone. In here there will be several files that allow the program to work.
